    ...
    <section id="about" className="section section--alt">
      <div className="container">
        ...
        <div className="about__body">
          <FadeIn delay={100}>
            <p>
              I'm a Software Engineer based in Finland with a background spanning software development and testing,
              industrial systems, and human-centered design. I hold two Master's degrees;
          ...
          <FadeIn delay={300}>
            <p>
              ...
              people using it. I'm actively looking for a software engineering role where
